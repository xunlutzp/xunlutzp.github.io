...
+ 如何获取辅修消息？
    ...
    1. 打开 http://tz.its.csu.edu.cn/ ，输入你的账户密码，在检索栏里输入“辅修”并检索，这样历年来的辅修通知你都可以看到。
        ...
        ![查找辅修相关通知](https://gitee.com/zcx980605/Survive_XYSM_dev/raw/master/Image/Ch1_11_1.png)
        ...
        ![查找辅修相关通知](https://gitee.com/zcx980605/Survive_XYSM_dev/raw/master/Image/Ch1_11_2.png)

    2. 点开通知，仔细阅读全文。最底下会有一个附件列表给你下载，这个是你要的宝贝。（红色箭头）辅修通知的附件发布有两种情况，一种是每个附件单独给你发布下载，一种是打包成rar（蓝色箭头）。在你的电脑上新建一个文件夹，把文件全下载，仔细阅读。

        ![辅修相关通知的附件](https://gitee.com/zcx980605/Survive_XYSM_dev/raw/master/Image/Ch1_11_3.png)
    ...
    3. 进入专业学院网站查找通知（以法学院为例）
        ...
        ![全网查找辅修相关通知](https://gitee.com/zcx980605/Survive_XYSM_dev/raw/master/Image/Ch1_11_4.png)
