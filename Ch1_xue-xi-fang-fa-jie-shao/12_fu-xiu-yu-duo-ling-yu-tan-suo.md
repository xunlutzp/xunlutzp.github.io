...
1. 打开 http://tz.its.csu.edu.cn/ ，输入你的账户密码，在检索栏里输入“辅修”并检索，这样历年来的辅修通知你都可以看到。
    ...
    <div align=center>
    <img src="https://xunlutzp.gitee.io/Image/Ch1_12_1.png" alt="查找辅修相关通知p1">
    </div>
    ...
    <div align=center>
    <img src="https://xunlutzp.gitee.io/Image/Ch1_12_2.png" alt="查找辅修相关通知p2">
    </div>

2. 点开通知，仔细阅读全文。最底下会有一个附件列表给你下载，这个是你要的宝贝。（红色箭头）辅修通知的附件发布有两种情况，一种是每个附件单独给你发布下载，一种是打包成rar（蓝色箭头）。在你的电脑上新建一个文件夹，把文件全下载，仔细阅读。

    <div align=center>
    <img src="https://xunlutzp.gitee.io/Image/Ch1_12_3.png" alt="辅修相关通知的附件">
    </div>
...
3. 进入专业学院网站查找通知（以法学院为例）
    ...
    <div align=center>
    <img src="https://xunlutzp.gitee.io/Image/Ch1_12_4.png" alt="全网查找辅修相关通知">
    </div>
